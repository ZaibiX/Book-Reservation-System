    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <p style={{ color: '#888', marginBottom: '40px' }}>
          Welcome to our digital library platform. Choose your role to get started.
        </p>

        <div style={rolesContainerStyle}>
          <div style={roleCardStyle}>
            <h3 style={{ color: '#333', marginBottom: '15px', fontSize: '1.5rem' }}>👨‍🎓 Student Portal</h3>
            ...
            <div>
              ...
              <Link href="/student/register" style={{ ...buttonStyle, backgroundColor: '#28a745' }}>
                Register Now
              </Link>
            </div>
          </div>
          ...
          <div style={roleCardStyle}>
            <h3 style={{ color: '#333', marginBottom: '15px', fontSize: '1.5rem' }}>👨‍💼 Librarian Portal</h3>
            <p style={{ color: '#666', marginBottom: '20px' }}>
              Manage books, handle reservations, and oversee library operations
            </p>
            <div>
              <Link href="/librarian/login" style={{ ...buttonStyle, backgroundColor: '#dc3545' }}>
                Librarian Login
              </Link>
            </div>
          </div>
        ...
        <div style={{ marginTop: '40px', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          <h4 style={{ color: '#333', marginBottom: '10px' }}>📋 Database Management System Project</h4>
