    ...
    <div style={containerStyle}>
      <header style={headerStyle}>
        <div style={headerContentStyle}>
          <div>
            <h1 style={{ margin: 0, color: '#333' }}>📋 Reservation Management</h1>
            <p style={{ margin: '5px 0 0', color: '#666' }}>Manage student book reservations</p>
          </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>Overdue</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <h3 style={{ margin: '0 0 5px', color: '#6c757d' }}>
                {reservations.filter(r => r.status === 'returned').length}
              </h3>
              <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>Returned</p>
            </div>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#f8f9fa' }}>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Student</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Book</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>ISBN</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Reserved</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Due Date</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Status</th>
                  <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #dee2e6' }}>Fine</th>
                ...
                {filteredReservations.map(reservation => (
                  <tr key={reservation.id}>
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>
                      <div>
                        <div style={{ fontWeight: 'bold' }}>{reservation.studentName}</div>
                        <div style={{ fontSize: '12px', color: '#666' }}>{reservation.studentEmail}</div>
                      </div>
                    </td>
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>{reservation.bookName}</td>
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>{reservation.isbn}</td>
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>{reservation.createdAt}</td>
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>
                    ...
                    <td style={{ padding: '12px', border: '1px solid #dee2e6' }}>
                      ...
                      {reservation.status === 'returned' && (
                        <span style={{ color: '#666', fontSize: '12px' }}>Completed</span>
                      )}
                    </td>
                  </tr>
                ))}
